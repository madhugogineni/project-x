  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <input
        ...
        required={required}
        className={[
          "w-full h-[2.75rem] px-3.5 border-[1.5px] rounded-md bg-surface-base text-text-primary text-sm placeholder:text-text-tertiary transition-all duration-[180ms]",
